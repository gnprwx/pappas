...
**EDIT NOV 11 2023**: I learned you can break out the async function in this circumstance (which I have done). Also, if you use promises and did this outside of a function, you could wrap it in a memoized function to have something similar to this. I also learned - but will not present it here - that this can be done using a reducer. However, that would be a bit much for this example I was working on.
